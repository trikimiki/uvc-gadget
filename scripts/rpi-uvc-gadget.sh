...
"
        ...
        create_frame $FUNCTION 640 480 mjpeg m "166666
200000
333333
416667
500000
...
"
        ...
        #
        # 1024 - slowest, but the most stable
        # 2048 - balanced for bandwith and stability, recommended
        # 3072 - fastest, but unstable, will most likely cause UVC to break
